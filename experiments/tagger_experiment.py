...
class SentenceTaggerConfig(TypedDict):
    input_type: SentenceTaggingInputType
...
def do_experiment(
    ...
    dataset_name: str,
    data_key: str,
    tagger_config: SentenceTaggerConfig
):
    ...
    with mlflow.start_run(
        ...
        tags={"dataset": dataset_name, "model_name": tagger_config["embedding_model_name"]},
    ) as run:
        # Setup Logger
        logger = MLFlowLogger(
...
def compute_embeddings(dataset_name: str, model_name: str, freeze_model: bool):
    do_experiment(
        ...
        data_key="sentences",
        tagger_config={
            "input_type": SentenceTaggingInputType.SENTENCES,
            "embedding_dim": None,
